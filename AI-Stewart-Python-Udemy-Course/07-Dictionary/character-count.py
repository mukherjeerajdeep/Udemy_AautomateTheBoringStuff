...
message = 'I am going to visit India when i will have some spare time and there  are nothing to say'
count = {} # 'r' : 12 

# string is a list of characters, so we can use it to count charatcers
for character in message:
    # reason in the dict is empty and will trhow error as the first
    #time this will be empty. So set a default value will work.
    # without this, there will be KeyError: 'I'
    count.setdefault(character, 0)
    # increament the character count after each iteration
    count[character] = count[character] + 1

print(count)

print()
print('using the UPPER')
